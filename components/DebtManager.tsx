...
import { HandCoins, Plus, Trash2, CheckCircle2, Receipt, CalendarClock } from 'lucide-react';
...
const DebtManager: React.FC<DebtManagerProps> = ({ debts, onAdd, onDelete, onTogglePaid }) => {
