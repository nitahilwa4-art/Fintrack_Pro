      ...
      <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-200">
        ...
        <div className="relative">
          <textarea
            ...
            className="w-full h-32 p-4 rounded-xl border border-slate-300 focus:border-purple-500 focus:ring-2 focus:ring-purple-200 transition-all resize-none text-slate-700 text-lg placeholder:text-slate-400"
            disabled={isLoading}
          />
